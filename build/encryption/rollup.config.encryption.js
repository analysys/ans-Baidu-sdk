  ...
  output: [
    {
      ...
      file: './baiduDemo/util/sdk/AnalysysAgent_encryption.min.js',
      format: 'cjs',
      name: 'Ans',
      plugins: [uglify({
        mangle: {
      ...
      file: './baiduDemo/util/sdk/AnalysysAgent_encryption.es6.min.js',
      format: 'esm',
      name: 'Ans',
      plugins: [terser({
        mangle: {
    ...
    {
      file: './testFrame(taro)/src/sdk/AnalysysAgent_encryption.es6.min.js',
      format: 'esm',
      name: 'Ans',
      plugins: [terser({
        mangle: {
